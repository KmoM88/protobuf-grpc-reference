...
type ChatMessage struct {
	...
	Timestamp     int64                  `protobuf:"varint,3,opt,name=timestamp,proto3" json:"timestamp,omitempty"` // For time-stamping messages
...
const file_chat_proto_rawDesc = "" +
	...
	"\ttimestamp\x18\x03 \x01(\x03R\ttimestamp2C\n" +
	"\vChatService\x124\n" +
	"\bJoinChat\x12\x11.chat.ChatMessage\x1a\x11.chat.ChatMessage(\x010\x01B\n" +
...
var file_chat_proto_depIdxs = []int32{
	0, // 0: chat.ChatService.JoinChat:input_type -> chat.ChatMessage
	0, // 1: chat.ChatService.JoinChat:output_type -> chat.ChatMessage
