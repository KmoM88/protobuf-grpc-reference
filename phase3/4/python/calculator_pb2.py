...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'Z\016./calculatorpb'
  ...
  _globals['_CALCULATORSERVICE']._serialized_start=189
  _globals['_CALCULATORSERVICE']._serialized_end=335
